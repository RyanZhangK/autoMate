...
Project Management: Notion (NOTION_API_KEY), Airtable (AIRTABLE_API_KEY), Linear (LINEAR_API_KEY), Jira (JIRA_EMAIL+API_TOKEN+BASE_URL), Confluence (CONFLUENCE_EMAIL+API_TOKEN+BASE_URL), Trello (TRELLO_API_KEY+TOKEN), Asana (ASANA_ACCESS_TOKEN), Monday.com (MONDAY_API_KEY), HubSpot (HUBSPOT_ACCESS_TOKEN)
Payments/E-commerce: Stripe (STRIPE_SECRET_KEY), Shopify (SHOPIFY_STORE_DOMAIN+ACCESS_TOKEN)
